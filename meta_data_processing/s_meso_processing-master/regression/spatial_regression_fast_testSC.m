function [output_sig, sig_blue, sig_uv] = spatial_regression_fast_testSC(blue_sig, uvsig, brain_mask, patch_size, delay_length) 
...
[sig_blue, sig_uv, output_sig]  = regress_filter_fast_testSC(rmmean_blue(:, delay_length+1:end), rmmean_uv(:, delay_length+1:end), brain_mask, patch_size);
