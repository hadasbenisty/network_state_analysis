...
function [dFoF,dFoF_parcells,R,C]= main_generic_meso_processing_newv_svdtest_11_modified(tiffsPath, dataSmrxFile,dataVisStimFile, outputPath, TmpFile,channels,params)
