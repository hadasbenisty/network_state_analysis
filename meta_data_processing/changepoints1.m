function [h1,OnTStamp ,OffTStamp ] =changepoints1(data, zThres,timestamps,inSampleRate,smoothWin, b1DoPlot,blDoPlotDuration,flipPlot)
...
OffIdx_int=OffIdx_int(OffIdx_int<=length(timestamps));
