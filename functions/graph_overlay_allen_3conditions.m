function graph_overlay_allen_3conditions(isloosestr, outputpth,cond1_cat,cond2_cat,cond3_cat,condition,name,plottitle,parcels_names,num, legstr)
    ...
    mysave(gcf, fullfile(outputpth,condition,strcat(name,'3conditions', isloosestr)), 'all');
end
