...
for dim_i = 1:dims
    params.emd{dim_i}.emd_fun = @CalcEmdAff;
    ...
    if isTopDown
        ...
        params.tree{dim_i}.clusteringAlgo = @kmeansWrapper;
        ...
        params.tree{dim_i}.runOnEmbdding        = false; % flex trees function does embedding inside
    end
