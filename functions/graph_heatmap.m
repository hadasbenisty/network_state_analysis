function graph_heatmap(outputpth,brain_mask,parcels,condition1,condition2,condition,name,plotitle)
isleftlabel=2:2:56;
...
mysave(gcf, fullfile(outputpth,condition,strcat(name,'_heatmap')), 'all');
end
