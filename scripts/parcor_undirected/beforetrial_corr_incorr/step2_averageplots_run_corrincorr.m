...
condition1='trial_run_correct';condition2='trial_run_incorrect';
...
for i=1:length(animals)
    ...
    trial_run_correct=load(strcat('X:\Lav\ProcessingDirectory\',animal,'\','network_analysis_corr',condition1),'W_corr','indic_corr','cent_corr','G_corr','names_corr');
    trial_run_incorrect=load(strcat('X:\Lav\ProcessingDirectory\',animal,'\','network_analysis_corr',condition2),'W_corr','indic_corr','cent_corr','G_corr','names_corr');   
...
graph_overlay_allen_paired(trial_run_correct_cat_degree,trial_run_incorrect_cat_degree,'trial_run_correct_trial_run_incorrect','degree_centrality','trial_run_correct vs trial_run_incorrect degree Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_run_correct_cat_closeness,trial_run_incorrect_cat_closeness,'trial_run_correct_trial_run_incorrect','closeness_centrality','trial_run_correct vs trial_run_incorrect closeness Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_run_correct_cat_pagerank,trial_run_incorrect_cat_pagerank,'trial_run_correct_trial_run_incorrect','pagerank_centrality','trial_run_correct vs trial_run_incorrect pagerank Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_run_correct_cat_eigenvector,trial_run_incorrect_cat_eigenvector,'trial_run_correct_trial_run_incorrect','eigenvector_centrality','trial_run_correct vs trial_run_incorrect eigenvector Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_run_correct_cat_betweenness,trial_run_incorrect_cat_betweenness,'trial_run_correct_trial_run_incorrect','betweenness_centrality','trial_run_correct vs trial_run_incorrect betweenness Centrality (spon)',parcels_names,length(animals));

graph_overlay_allen_notpaired(trial_run_correct_cat_eigenvector,trial_run_incorrect_cat_eigenvector,'trial_run_correct_trial_run_incorrect','eigenvector_centrality','trial_run_correct vs trial_run_incorrect eigenvector Centrality (spon)',parcels_names,length(animals));
