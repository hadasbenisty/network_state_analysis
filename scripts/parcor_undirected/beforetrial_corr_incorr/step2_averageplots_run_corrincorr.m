...
graph_overlay_allen_paired(outputpth, trial_run_correct_cat_pagerank,trial_run_incorrect_cat_pagerank,'trial_run_correct_trial_run_incorrect','pagerank_centrality','trial_run_correct vs trial_run_incorrect pagerank Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_notpaired(outputpth, trial_run_correct_cat_eigenvector,trial_run_incorrect_cat_eigenvector,'trial_run_correct_trial_run_incorrect','eigenvector_centrality','trial_run_correct vs trial_run_incorrect eigenvector Centrality (spon)',parcels_names,length(animals));

graph_overlay_allen_paired(outputpth, trial_run_correct_cat_degree,trial_run_incorrect_cat_degree,'trial_run_correct_trial_run_incorrect','degree_centrality','trial_run_correct vs trial_run_incorrect degree Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(outputpth, trial_run_correct_cat_closeness,trial_run_incorrect_cat_closeness,'trial_run_correct_trial_run_incorrect','closeness_centrality','trial_run_correct vs trial_run_incorrect closeness Centrality (spon)',parcels_names,length(animals));
