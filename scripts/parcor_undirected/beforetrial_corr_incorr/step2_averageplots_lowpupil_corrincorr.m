...
graph_heatmap(outputpth,braininfo.brain_mask,parcelsallen.parcells_new.indicators, trial_lowpup_correct_cat_degree,trial_lowpup_incorrect_cat_degree,'trial_lowpup_correct_trial_lowpup_incorrect','degree_centrality','trial_lowpup_correct vs trial_lowpup_incorrect degree Centrality (spon)');
graph_heatmap(outputpth,braininfo.brain_mask,parcelsallen.parcells_new.indicators, trial_lowpup_correct_cat_closeness,trial_lowpup_incorrect_cat_closeness,'trial_lowpup_correct_trial_lowpup_incorrect','closeness_centrality','trial_lowpup_correct vs trial_lowpup_incorrect closeness Centrality (spon)');
graph_heatmap(outputpth,braininfo.brain_mask,parcelsallen.parcells_new.indicators, trial_lowpup_correct_cat_pagerank,trial_lowpup_incorrect_cat_pagerank,'trial_lowpup_correct_trial_lowpup_incorrect','pagerank_centrality','trial_lowpup_correct vs trial_lowpup_incorrect pagerank Centrality (spon)');
graph_heatmap(outputpth,braininfo.brain_mask,parcelsallen.parcells_new.indicators, trial_lowpup_correct_cat_eigenvector,trial_lowpup_incorrect_cat_eigenvector,'trial_lowpup_correct_trial_lowpup_incorrect','eigenvector_centrality','trial_lowpup_correct vs trial_lowpup_incorrect eigenvector Centrality (spon)');
graph_heatmap(outputpth,braininfo.brain_mask,parcelsallen.parcells_new.indicators, trial_lowpup_correct_cat_betweenness,trial_lowpup_incorrect_cat_betweenness,'trial_lowpup_correct_trial_lowpup_incorrect','betweenness_centrality','trial_lowpup_correct vs trial_lowpup_incorrect betweenness Centrality (spon)');
