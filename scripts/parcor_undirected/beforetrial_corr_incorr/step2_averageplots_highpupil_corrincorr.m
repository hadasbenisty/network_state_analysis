...
for i=1:length(animals)
    ...
    trial_highpup_correct=load(strcat('X:\Lav\ProcessingDirectory\',animal,'\','network_analysis_corr',condition1),'W_corr','indic_corr','cent_corr','G_corr','names_corr');
    trial_highpup_incorrect=load(strcat('X:\Lav\ProcessingDirectory\',animal,'\','network_analysis_corr',condition2),'W_corr','indic_corr','cent_corr','G_corr','names_corr');   
...
graph_overlay_allen_paired(trial_highpup_correct_cat_degree,trial_highpup_incorrect_cat_degree,'trial_highpup_correct_trial_highpup_incorrect','degree_centrality','trial_highpup_correct vs trial_highpup_incorrect degree Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_highpup_correct_cat_closeness,trial_highpup_incorrect_cat_closeness,'trial_highpup_correct_trial_highpup_incorrect','closeness_centrality','trial_highpup_correct vs trial_highpup_incorrect closeness Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_highpup_correct_cat_pagerank,trial_highpup_incorrect_cat_pagerank,'trial_highpup_correct_trial_highpup_incorrect','pagerank_centrality','trial_highpup_correct vs trial_highpup_incorrect pagerank Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_highpup_correct_cat_eigenvector,trial_highpup_incorrect_cat_eigenvector,'trial_highpup_correct_trial_highpup_incorrect','eigenvector_centrality','trial_highpup_correct vs trial_highpup_incorrect eigenvector Centrality (spon)',parcels_names,length(animals));
graph_overlay_allen_paired(trial_highpup_correct_cat_betweenness,trial_highpup_incorrect_cat_betweenness,'trial_highpup_correct_trial_highpup_incorrect','betweenness_centrality','trial_highpup_correct vs trial_highpup_incorrect betweenness Centrality (spon)',parcels_names,length(animals));

graph_overlay_allen_notpaired(trial_highpup_correct_cat_eigenvector,trial_highpup_incorrect_cat_eigenvector,'trial_highpup_correct_trial_highpup_incorrect','eigenvector_centrality','trial_highpup_correct vs trial_highpup_incorrect eigenvector Centrality (spon)',parcels_names,length(animals));
