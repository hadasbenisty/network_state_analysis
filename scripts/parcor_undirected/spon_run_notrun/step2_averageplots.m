...
for i=1:length(animals)
    ...
    spon_run=load(strcat('X:\Lav\ProcessingDirectory_spet29\',animal,'\','network_analysis_corr',condition1),'W_corr','indic_corr','cent_corr','G_corr','names_corr');
    spon_notrun=load(strcat('X:\Lav\ProcessingDirectory_spet29\',animal,'\','network_analysis_corr',condition2),'W_corr','indic_corr','cent_corr','G_corr','names_corr');   
...
graph_overlay_allen_paired(spon_run_cat_closeness,spon_notrun_cat_closeness,'spon_run_notrun','closeness_centrality','run vs notrun closeness Centrality (spon)',parcels_names,length(animals));
